...
public class ParallelProblemTest {
	...
	@Before public void setUp() {
		problem = new ParallelProblem<>(dimension, min, max);
	}

	@Test public void testDimension() {
		assertThat(problem.dimension()).isEqualTo(dimension);
	}
	...
	@Test public void testLowerBound() {
		assertThat(problem.lowerBound(0)).isEqualTo(min);
		assertThat(problem.lowerBound(1)).isEqualTo(min);
		assertThat(problem.lowerBound(2)).isEqualTo(min);
	}
	...
	@Test public void testUpperBound() {
		assertThat(problem.upperBound(0)).isEqualTo(max);
		assertThat(problem.upperBound(1)).isEqualTo(max);
		assertThat(problem.upperBound(2)).isEqualTo(max);
	}
}
