 ...
 */
@FunctionalInterface
public interface SolutionDecoder<S extends Solution<?>, T extends Solution<?>> extends Function1<S, T> {
	 ...
	 */
	T decodeSolution(S solution);

	@Override default T apply(final S s) {
		return decodeSolution(s);
	}
}
