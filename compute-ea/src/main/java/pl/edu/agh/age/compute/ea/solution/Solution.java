 ...
 */
public interface Solution<T extends Serializable> extends Serializable {
	/**
	 ...
	 *
	 * @return a copy of this solution with new evaluation
	 */
	...
	Solution<T> cloneWithNewValue(T value);
}
