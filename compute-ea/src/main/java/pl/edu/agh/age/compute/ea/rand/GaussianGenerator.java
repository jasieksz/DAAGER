...
/**
 * An implementation of {@link DoubleSymmetricGenerator} which generates values on the base of a Gaussian distribution.
 */
public final class GaussianGenerator implements DoubleSymmetricGenerator {
	...
	public GaussianGenerator(final NormalizedDoubleRandomGenerator rand) {
	...
	private static final class NormalCdf {
		...
		private static final double[] INV_NORMAL_2_P_2 = {-0.152389263440726128E-1, 0.3444556924136125216,
			-0.29344398672542478687E1, 0.11763505705217827302E2, -0.22655292823101104193E2, 0.19121334396580330163E2,
			-0.5478927619598318769E1, 0.237516689024448000};

		private static final double[] INV_NORMAL_2_Q_2 = {-0.108465169602059954E-1, 0.2610628885843078511,
			-0.24068318104393757995E1, 0.10695129973387014469E2, -0.23716715521596581025E2, 0.24640158943917284883E2,
		...
		private static final double[] INV_NORMAL_2_P_3 = {0.56451977709864482298E-4, 0.53504147487893013765E-2,
			...
			0.20789742630174917228E1, 0.72718806231556811306, 0.66816807711804989575E-1, -0.17791004575111759979E-1,
