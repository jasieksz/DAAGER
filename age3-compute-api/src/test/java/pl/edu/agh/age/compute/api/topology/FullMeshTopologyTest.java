...
public final class FullMeshTopologyTest {

	private static final String[] annotations = {"0", "1", "2", "3", "4", "5"};

	private FullMeshTopology<Integer> topology = null;
	...
	@Test public void test() throws Exception {
		...
		assertThat(ids).describedAs("all vertices satisfy").allSatisfy(i -> {
			assertThat(graph.outDegreeOf(i)).describedAs("out degree of vertex is 6").isEqualTo(6);
